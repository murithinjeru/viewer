...
const commandsModule = ({ servicesManager }) => {
  const actions = {
    ...
    runAiModel: ({ viewports }) => {
      let element = cornerstone.getEnabledElements()[0].element;
      let canvas = element.children[0];
      let ctx = canvas.getContext('2d');
      let img = new Image();
      img.src = pd.makePrediction(); // url to image generated by AI in my server
